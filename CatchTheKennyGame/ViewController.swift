...
//  CatchTheKennyGame
//
//  Created by Gizem Zorlu on 11.05.2023.
//
    ...
    @objc func countDown() {
        ...
        if counter < 0 {
            ...
            let replayButton = UIAlertAction(title: "Replay", style: UIAlertAction.Style.default) { [self]
                ...
                self.hideTimer = Timer.scheduledTimer(timeInterval: 0.75, target: self, selector: #selector(self.hideKenny), userInfo: nil, repeats: true)
